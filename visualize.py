...
if __name__ == "__main__":
    ...
    parser.add_argument("--pcd_path", default="/mnt/edisk/backup/result/sparse/7015_66555_no_color.pcd", type=str)
    parser.add_argument("--labels_path", default="/mnt/edisk/backup/result/sparse/7015_66555_no_color.labels", type=str)
